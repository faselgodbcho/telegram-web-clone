  ...
  return (
    <form className="mt-6 pb-4" onSubmit={handleUserLogin} noValidate>
      ...
      <button
        type="submit"
        disabled={loggingIn}
        className={`w-full p-3 dark:bg-secondary-dark bg-secondary-light text-primary-light font-medium rounded-xl mt-4 text-lg  flex justify-center gap-4 items-center ${!loggingIn ? "hover:bg-opacity-80" : "disabled:bg-opacity-50 cursor-not-allowed"}`}
      >
